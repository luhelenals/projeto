...
class RecebimentosRepository {
  static setupRecebimento() {
    return [
      RecebimentoMensal(listaRecebimentos: [
        Recebimento(
            valor: 500.23, data: DateTime(2024, 5, 6), descricao: 'pix'),
        Recebimento(
      ...
      RecebimentoMensal(listaRecebimentos: [
        Recebimento(
            valor: 500.40, data: DateTime(2024, 3, 13), descricao: 'Pix'),
        Recebimento(
      ...
      RecebimentoMensal(listaRecebimentos: [
        Recebimento(
            valor: 500.23, data: DateTime(2024, 1, 30), descricao: 'pix'),
        Recebimento(
  ...
  static RecebimentoMensal obterRecebimentoMensal(int n) {
    RecebimentoMensal recebimentos = setupRecebimento()
        .firstWhere((recebimento) => recebimento.mes.num == n);
    return recebimentos;
  }

  static void adicionarRecebimento(int mes, Recebimento recebimento) {
    var recebimentoMensal =
        setupRecebimento().firstWhere((element) => element.mes.num == mes);
    recebimentoMensal.listaRecebimentos.add(recebimento);
  }
}
